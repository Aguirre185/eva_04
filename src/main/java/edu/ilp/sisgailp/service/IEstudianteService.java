...
public interface IEstudianteService {
    ...
    //Este método registra un estudiante - Este metodo tambien se puede usar para actualizar estudiantes
    ...
    //Eliminar un estudiante de la base de datos - el long solo es variable no hay en la entity
